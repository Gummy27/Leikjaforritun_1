...
// Þetta skrift verður notað til að láta myndavélina/ljósið fylgja spilaranum (kassanum).
public class FollowPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        // Staðsetning myndavélarinnar er reiknuð út frá x, y, z staðsetningu spilarans og x, y, z gildi offset sem færir myndavélina/ljósið aðeins til baka.
